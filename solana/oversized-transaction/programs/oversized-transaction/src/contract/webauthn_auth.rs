...
pub fn verify_webauthn_signature_impl(
    ...
    let offsets: Secp256r1SignatureOffsets =
        bytemuck::try_from_bytes::<Secp256r1SignatureOffsets>(offsets_data)
    ...
    if pubkey_bytes != expected_pubkey_bytes.as_slice() {
    ...
    let expected_signed_data = [
        authenticator_data_bytes.as_slice(),
